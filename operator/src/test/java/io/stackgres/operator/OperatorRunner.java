...
public class OperatorRunner implements CheckedRunnable, Closeable {
  ...
  private void setup() throws Exception {
    ...
    final Path sidecarClassLocation = Paths.get(URI.create(
        PostgresUtil.class.getClassLoader().getResource(
            PostgresUtil.class.getName().replace('.', File.separatorChar) + ".class").toURI().toString()
        .replace(PostgresUtil.class.getName().replace('.', File.separatorChar) + ".class", "")));
    final Path commonClassLocation = Paths.get(URI.create(
        StackGresUtil.class.getClassLoader().getResource(
            StackGresUtil.class.getName().replace('.', File.separatorChar) + ".class").toURI().toString()
        .replace(StackGresUtil.class.getName().replace('.', File.separatorChar) + ".class", "")));
