---
title: Metrics exposed
weight: 1
url: administration/monitoring/metrics
---

The next tables shows the metrics exposed by StackGres and a description of each metrics. All these metrics are used to create all the monitoring dashboards with Prometheus and Grafana.
