...
The `SGCluster` depends on other objects to work properly, such as [instance profiles]({{% relref "/06-crd-reference/02-instance-profiles" %}}),
 [postgres configurations]({{% relref "/06-crd-reference/03-postgres-configuration" %}}), [connection pooling]({{% relref "/06-crd-reference/04-connection-pooling-configuration/" %}}),
 [backup configurations]({{% relref "/06-crd-reference/05-backup-config/" %}}), [backups]({{% relref "/06-crd-reference/06-backups/" %}}),
 [distributed logs]({{% relref "/06-crd-reference/07-distributed-logs" %}}), .
