...
export E2E_DISABLE_CONTAINERD_CACHE=true
export E2E_REGISTRY_MIRROR=true
export E2E_REGISTRY_MIRROR_PATH="${E2E_TEMP_PATH}/kind-registry-mirror"
export E2E_REGISTRY_MIRROR_HOSTS="docker.io quay.io registry.k8s.io ghcr.io $CI_REGISTRY${EXTRA_REGISTRY:+ $EXTRA_REGISTRY}"
