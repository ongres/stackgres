var CreateCluster = Vue.component("CreateCluster", {
                ...
                <div>
                    ...
                    <template v-if="advancedMode">                        
                        ...
                        <fieldset>
                            ...
                            <textarea v-model="annotationsAll" placeholder="annotation = value" data-field="spec.metadata.annotations.allResources" :disabled="editMode"></textarea>
                            ...
                            <textarea v-model="annotationsPods" placeholder="annotation = value" data-field="spec.metadata.annotations.pods" :disabled="editMode"></textarea>
                            ...
                            <textarea v-model="annotationsServices" placeholder="annotation = value" data-field="spec.metadata.annotations.services" :disabled="editMode"></textarea>
            ...
            if(vm.$route.params.action === 'edit') {
                store.state.clusters.forEach(function( c ){
                    if( (c.data.metadata.name === vm.$route.params.name) && (c.data.metadata.namespace === vm.$route.params.namespace) ) {
                        ...
                        vm.postgresServicesPrimary = true;
                        vm.postgresServicesPrimaryType = '';
                        vm.postgresServicesPrimaryAnnotations = '';
                        vm.postgresServicesReplicas = true;
                        vm.postgresServicesReplicasType = '';
                        vm.postgresServicesReplicasAnnotations = '';
    ...
    methods: {
        ...
        parseProps ( props ) {
			return JSON.parse('{"' + props.replace(/\n/g, '","').replace(/\s/g,'').replace(/=/g,'":"') + '"}')
        },
        
        unparseProps ( props ) {
            return JSON.stringify(props).replace(/"/g,'').replace(/:/g,' = ').replace('{','').replace(/,/g,'\n').replace('}','')
		}
