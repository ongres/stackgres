            ...
            <div class="form">
                ...
                <fieldset class="fieldset" required v-if="backupConfigStorageType.length">
                    ...
                    <template v-if="backupConfigStorageType === 'gcs'">
                        ...
                        <label for="fetchGCSCredentials" class="switch yes-no">Fetch <input type="checkbox" id="fetchGCSCredentials" v-model="fetchGCSCredentials" data-switch="NO" :disabled="(editMode)"></label>
