var CreatePoolConfig = Vue.component("CreatePoolConfig", {
            ...
            <header>
                <ul class="breadcrumbs">
                    ...
                    <li class="action">
                        ...
                        <router-link :to="'/admin/configurations/connectionpooling/'+currentNamespace" title="SGPoolingConfigs">SGPoolingConfigs</router-link>
                    </li>
                    <li v-if="editMode">
                        <router-link :to="'/admin/configurations/connectionpooling/'+currentNamespace+'/'+$route.params.name" title="Configuration Details">{{ $route.params.name }}</router-link>
                    </li>
                    <li class="action">
	...
	computed: {
        ...
        config() {
            ...
            if( (vm.$route.name === 'EditPoolConfig') && !vm.editReady) {
    ...
    methods: {
            ...
            if(isValid) {
                ...
                if(this.editMode) {
                    ...
                    .then(function (response) {
                        ...
                        router.push('/admin/configurations/connectionpooling/'+config.metadata.namespace+'/'+config.metadata.name);
                    })
        ...
        cancel: function() {
            router.push('/admin/configurations/connectionpooling/'+store.state.currentNamespace);
        },
