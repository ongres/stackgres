            ...
            <header>
                <ul class="breadcrumbs">
                    ...
                    <li class="action">
                        ...
                        <router-link :to="'/configurations/connectionpooling/'+currentNamespace" title="SGPoolingConfigs">SGPoolingConfigs</router-link>
                    </li>
                    <li v-if="editMode">
                        <router-link :to="'/configurations/connectionpooling/'+currentNamespace+'/'+$route.params.name" title="Configuration Details">{{ $route.params.name }}</router-link>
                    </li>
                    <li class="action">
                        {{ $route.params.action }}
                    </li>
