            ...
            <header>
                <ul class="breadcrumbs">
                    ...
                    <li class="action">
                        ...
                        <router-link :to="'/admin/configurations/postgres/'+currentNamespace" title="SGPostgresConfigs">SGPostgresConfigs</router-link>
                    </li>
                    <li v-if="editMode">
                        <router-link :to="'/admin/configurations/postgres/'+currentNamespace+'/'+$route.params.name" title="Configuration Details">{{ $route.params.name }}</router-link>
                    </li>
                    <li class="action">
                        {{ $route.params.action }}
                    </li>
