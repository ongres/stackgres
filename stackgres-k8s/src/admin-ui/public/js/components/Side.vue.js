		...
		<aside id="side" :class="currentNamespace" v-if="loggedIn && isReady">
			...
			<div id="sets">
				<div v-if="iCan('','sgclusters')" class="set clu" :class="$route.params.hasOwnProperty('cluster') || currentComponent == 'CreateCluster' || currentComponent == 'ClusterOverview' ? 'active' : ''" >
					...
					<router-link :to="'/admin/crd/create/cluster/'+currentNamespace" class="addnew" v-if="iCan('create', 'sgclusters', currentNamespace)">
				...
				<div v-if="iCan('','sginstanceprofiles')" class="prof set" :class="currentComponent == 'InstanceProfile'  || currentComponent == 'CreateProfile' ? 'active' : ''">
					...
					<router-link :to="'/admin/crd/create/profile/'+currentNamespace" class="addnew" v-if="iCan('create', 'sginstanceprofiles', currentNamespace)">
						<svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" viewBox="0 0 19 19"><g transform="translate(-573 -706)"><g transform="translate(573 706)" fill="none" stroke="#00adb5" stroke-width="2"><circle cx="9.5" cy="9.5" r="9.5" stroke="none"/><circle cx="9.5" cy="9.5" r="8.5" fill="none"/></g><g transform="translate(-30.5 28.8)"><g transform="translate(609 686)" fill="#00adb5" stroke="#00adb5" stroke-width="1"><rect width="8" height="1.4" rx="0.7" stroke="none"/><rect x="0.5" y="0.5" width="7" height="0.4" rx="0.2" fill="none"/></g><g transform="translate(613.7 682.7) rotate(90)" fill="#00adb5" stroke="#00adb5" stroke-width="1"><rect width="8" height="1.4" rx="0.7" stroke="none"/><rect x="0.5" y="0.5" width="7" height="0.4" rx="0.2" fill="none"/></g></g></g></svg>
					</router-link>
					<ul v-if="iCan('list', 'sginstanceprofiles', currentNamespace)">
				...
				<div class="set conf active">
					...
					<ul>
						<div v-if="iCan('','sgpgconfigs')" class="pg set" :class="currentComponent == 'PostgresConfig' || currentComponent == 'CreatePgConfig' ? 'active' : ''">
							...
							<router-link :to="'/admin/crd/create/pgconfig/'+currentNamespace" class="addnew" v-if="iCan('create', 'sgpgconfigs', currentNamespace)">
								<svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" viewBox="0 0 19 19"><g transform="translate(-573 -706)"><g transform="translate(573 706)" fill="none" stroke="#00adb5" stroke-width="2"><circle cx="9.5" cy="9.5" r="9.5" stroke="none"/><circle cx="9.5" cy="9.5" r="8.5" fill="none"/></g><g transform="translate(-30.5 28.8)"><g transform="translate(609 686)" fill="#00adb5" stroke="#00adb5" stroke-width="1"><rect width="8" height="1.4" rx="0.7" stroke="none"/><rect x="0.5" y="0.5" width="7" height="0.4" rx="0.2" fill="none"/></g><g transform="translate(613.7 682.7) rotate(90)" fill="#00adb5" stroke="#00adb5" stroke-width="1"><rect width="8" height="1.4" rx="0.7" stroke="none"/><rect x="0.5" y="0.5" width="7" height="0.4" rx="0.2" fill="none"/></g></g></g></svg>
							</router-link>
							<ul v-if="iCan('list', 'sgpgconfigs', currentNamespace)">
						...
						<div v-if="iCan('','sgpoolconfigs')" class="pool set" :class="currentComponent == 'PoolConfig' || currentComponent == 'CreatePoolConfig' ? 'active' : ''">
							...
							<ul v-if="iCan('list', 'sgpoolconfigs', currentNamespace)">
							...
							<router-link :to="'/admin/crd/create/connectionpooling/'+currentNamespace" class="addnew" v-if="iCan('create', 'sgpoolconfigs', currentNamespace)">
								<svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" viewBox="0 0 19 19"><g transform="translate(-573 -706)"><g transform="translate(573 706)" fill="none" stroke="#00adb5" stroke-width="2"><circle cx="9.5" cy="9.5" r="9.5" stroke="none"/><circle cx="9.5" cy="9.5" r="8.5" fill="none"/></g><g transform="translate(-30.5 28.8)"><g transform="translate(609 686)" fill="#00adb5" stroke="#00adb5" stroke-width="1"><rect width="8" height="1.4" rx="0.7" stroke="none"/><rect x="0.5" y="0.5" width="7" height="0.4" rx="0.2" fill="none"/></g><g transform="translate(613.7 682.7) rotate(90)" fill="#00adb5" stroke="#00adb5" stroke-width="1"><rect width="8" height="1.4" rx="0.7" stroke="none"/><rect x="0.5" y="0.5" width="7" height="0.4" rx="0.2" fill="none"/></g></g></g></svg>
							</router-link>
						</div>

						<div v-if="iCan('','sgbackupconfigs')" class="backup set" :class="currentComponent == 'BackupConfig' || currentComponent == 'CreateBackupConfig' ? 'active' : ''">
							...
							<router-link :to="'/admin/crd/create/backupconfig/'+currentNamespace" class="addnew" v-if="iCan('create', 'sgbackupconfigs', currentNamespace)">
								<svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" viewBox="0 0 19 19"><g transform="translate(-573 -706)"><g transform="translate(573 706)" fill="none" stroke="#00adb5" stroke-width="2"><circle cx="9.5" cy="9.5" r="9.5" stroke="none"/><circle cx="9.5" cy="9.5" r="8.5" fill="none"/></g><g transform="translate(-30.5 28.8)"><g transform="translate(609 686)" fill="#00adb5" stroke="#00adb5" stroke-width="1"><rect width="8" height="1.4" rx="0.7" stroke="none"/><rect x="0.5" y="0.5" width="7" height="0.4" rx="0.2" fill="none"/></g><g transform="translate(613.7 682.7) rotate(90)" fill="#00adb5" stroke="#00adb5" stroke-width="1"><rect width="8" height="1.4" rx="0.7" stroke="none"/><rect x="0.5" y="0.5" width="7" height="0.4" rx="0.2" fill="none"/></g></g></g></svg>
							</router-link>
				...
				<div v-if="iCan('', 'sgdistributedlogs')" class="set logs" :class="currentComponent == 'LogsCluster' || currentComponent == 'CreateLogsCluster' ? 'active' : ''">
					<router-link :to="'/admin/logs/'+currentNamespace" title="Centralized Logs Clusters" class="nav-item">
						...
						<h3>Distributed Logs Server</h3>
					</router-link>
					<router-link :to="'/admin/crd/create/logs/'+currentNamespace" class="addnew" v-if="iCan('create', 'sgdistributedlogs', currentNamespace)">
						<svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" viewBox="0 0 19 19"><g transform="translate(-573 -706)"><g transform="translate(573 706)" fill="none" stroke="#00adb5" stroke-width="2"><circle cx="9.5" cy="9.5" r="9.5" stroke="none"/><circle cx="9.5" cy="9.5" r="8.5" fill="none"/></g><g transform="translate(-30.5 28.8)"><g transform="translate(609 686)" fill="#00adb5" stroke="#00adb5" stroke-width="1"><rect width="8" height="1.4" rx="0.7" stroke="none"/><rect x="0.5" y="0.5" width="7" height="0.4" rx="0.2" fill="none"/></g><g transform="translate(613.7 682.7) rotate(90)" fill="#00adb5" stroke="#00adb5" stroke-width="1"><rect width="8" height="1.4" rx="0.7" stroke="none"/><rect x="0.5" y="0.5" width="7" height="0.4" rx="0.2" fill="none"/></g></g></g></svg>
					</router-link>
				</div>
				<div v-if="iCan('','sgbackups')" class="set backups" :class="currentComponent == 'Backups' || currentComponent == 'CreateBackups' ? 'active' : ''">
					...
					<router-link :to="'/admin/crd/create/backup/'+currentNamespace" class="addnew" v-if="iCan('create', 'sgbackups', currentNamespace)">
						<svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" viewBox="0 0 19 19"><g transform="translate(-573 -706)"><g transform="translate(573 706)" fill="none" stroke="#00adb5" stroke-width="2"><circle cx="9.5" cy="9.5" r="9.5" stroke="none"/><circle cx="9.5" cy="9.5" r="8.5" fill="none"/></g><g transform="translate(-30.5 28.8)"><g transform="translate(609 686)" fill="#00adb5" stroke="#00adb5" stroke-width="1"><rect width="8" height="1.4" rx="0.7" stroke="none"/><rect x="0.5" y="0.5" width="7" height="0.4" rx="0.2" fill="none"/></g><g transform="translate(613.7 682.7) rotate(90)" fill="#00adb5" stroke="#00adb5" stroke-width="1"><rect width="8" height="1.4" rx="0.7" stroke="none"/><rect x="0.5" y="0.5" width="7" height="0.4" rx="0.2" fill="none"/></g></g></g></svg>
					</router-link>
				</div>
			</div>
