	...
	template: `
		<div id="sg-backup">
			<header v-if="isCluster">
				...
				<div class="actions" v-if="typeof currentCluster.data !== 'undefined'">
				...
				<ul class="tabs">
					...
					<li v-if="(typeof currentCluster.data !== 'undefined') && (typeof currentCluster.data.spec.distributedLogs !== 'undefined')">
					...
					<li v-if="(typeof currentCluster.data !== 'undefined') && currentCluster.data.grafanaEmbedded">
								...
								<template v-if="back.data.status">
									<tr :class="[ back.data.status.process.status != 'Running' ? 'base' : '', back.data.status.process.status+' sgbackup-'+back.data.metadata.namespace+'-'+back.data.metadata.name]">
										...
										<td class="actions">
											...
											<router-link :to="'/admin/crd/edit/backup/'+$route.params.namespace+'/'+back.data.spec.sgCluster+'/'+back.name" title="Edit Backup">
