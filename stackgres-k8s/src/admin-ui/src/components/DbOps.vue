            ...
            <template v-else>
                ...
                <template v-for="(op, index) in dbOps" v-if="op.name == $route.params.name">
                    ...
                    <template v-if="(op.data.spec.op == 'minorVersionUpgrade')">
                        <div class="clusterStatus flex flex-50" v-for="status in op.data.status.conditions">
                            <div class="pods">
                                <template v-for="(pod, index) in upgradeCluster.status.pods">
                                    <h3 class="header xsPad" v-if="pod.role == 'primary'">
                                        Primary
                                    </h3>
