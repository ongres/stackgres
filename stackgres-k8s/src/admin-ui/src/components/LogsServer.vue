                            ...
                            <template  v-if="(index >= pagination.start) && (index < pagination.end)">
                                <tr class="base">
                                    <td class="hasTooltip clusterName">
                                        <span>
                                            <router-link :to="'/logs/' + $route.params.namespace + '/' + cluster.name" class="noColor">
                                                {{ cluster.name }}
                                            </router-link>
                                        </span>
                                    </td>
                                    ...
                                    <td class="actions">
                                        <router-link :to="'/logs/' + $route.params.namespace + '/' + cluster.name" target="_blank" class="newTab">
