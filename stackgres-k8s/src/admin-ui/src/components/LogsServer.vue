                    ...
                    <template v-for="cluster in clusters" v-if="(cluster.data.metadata.namespace == $route.params.namespace)">
                        <tr class="base" :class="[ $route.params.name == cluster.data.metadata.name ? 'open' : '', 'logs-'+cluster.data.metadata.namespace+'-'+cluster.data.metadata.name ]" :data-name="cluster.data.metadata.name">
                            ...
                            <td class="actions">
                                ...
                                <a v-if="iCan('delete','sgdistributedlogs',$route.params.namespace) && !cluster.data.status.clusters.length" v-on:click="deleteCRD('sgdistributedlogs',$route.params.namespace, cluster.data.metadata.name, '/logs/' + $route.params.namespace)" class="delete" title="Delete Configuration">
