								...
								<template v-if="(index >= pagination.start) && (index < pagination.end)">
									<tr class="base">
										<td class="clusterName">
											<router-link :to="'/cluster/status/'+$route.params.namespace+'/'+cluster.name" title="Cluster Status" data-active=".set.clu" class="noColor">
												{{ cluster.name }}
											</router-link>
										...
										<td class="cpu">
											<router-link :to="'/cluster/status/'+$route.params.namespace+'/'+cluster.name" title="Cluster Status" data-active=".set.clu" class="noColor" v-if="hasProp(cluster,'status.cpuRequested')">
												{{ cluster.status.cpuRequested }}
											</router-link>
										</td>
										<td class="ram">
											<router-link :to="'/cluster/status/'+$route.params.namespace+'/'+cluster.name" title="Cluster Status" data-active=".set.clu" class="noColor" v-if="hasProp(cluster,'status.memoryRequested')">
										...
										<td class="actions">
											<router-link :to="'/cluster/status/'+$route.params.namespace+'/'+cluster.name" target="_blank" class="newTab">
