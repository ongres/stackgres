        ...
        <div class="info">
            ...
            <div class="content">
                ...
                <div class="summary" v-if="cluster.hasOwnProperty('data')">
                    ...
                    <ul class="section" v-if="showDefaults || hasProp(cluster, 'data.spec.coordinator.pods.disableConnectionPooling') || hasProp(cluster, 'data.spec.coordinator.configurations.sgPoolingConfig') || hasProp(cluster, 'data.spec.coordinator.pods.disablePostgresUtil') || hasProp(cluster, 'data.spec.coordinator.pods.disableMetricsExporter')">
                        <li>
                            <button class="toggleSummary"></button>
                            <strong class="sectionTitle">Sidecars </strong>
                            <ul>
                    ...
                    <ul class="section" v-if="showDefaults || hasProp(cluster, 'data.spec.shards.pods.disableConnectionPooling') || hasProp(cluster, 'data.spec.shards.configurations.sgPoolingConfig') || hasProp(cluster, 'data.spec.shards.pods.disablePostgresUtil') || hasProp(cluster, 'data.spec.shards.pods.disableMetricsExporter')">
                        <li>
                            <button class="toggleSummary"></button>
                            <strong class="sectionTitle">Sidecars </strong>
                            <ul>
                            ...
                            <ul>
                                <template v-for="(override, overrideIndex) in cluster.data.spec.shards.overrides">
                                    <li :key="'override-' + override.index">
                                        ...
                                        <ul v-if="hasProp(override, 'pods.disableConnectionPooling') || hasProp(override, 'configurations.sgPoolingConfig') || hasProp(override, 'pods.disablePostgresUtil') || hasProp(override, 'pods.disableMetricsExporter')">
                                            <li>
                                                <button class="toggleSummary"></button>
                                                <strong class="sectionTitle">Sidecars </strong>
                                                <ul>
