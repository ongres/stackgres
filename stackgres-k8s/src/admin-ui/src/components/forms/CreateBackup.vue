        ...
        <header>
            <ul class="breadcrumbs">
                ...
                <template v-if="$route.params.hasOwnProperty('cluster')">
                    ...
                    <li>
						<router-link :to="'/cluster/status/'+$route.params.namespace+'/'+$route.params.cluster" title="Status">{{ $route.params.cluster }}</router-link>
					</li>
                    <li>
                        <router-link :to="'/cluster/backups/'+$route.params.namespace+'/'+$route.params.cluster" title="Backups">Backups</router-link>
                    </li>
                </template>
                <template v-else>
                    <li>
