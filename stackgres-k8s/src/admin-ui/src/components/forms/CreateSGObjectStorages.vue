                ...
                <div class="col">
                    <div class="optionBoxes withLogos">
                        <label for="s3" data-field="spec.type" :class="( (type == 's3') && 'active' )" tabindex="0">
                            ...
                            Amazon S3
                            <input type="radio" :required='!editMode' v-model="type" value="s3" id="s3" data-field="spec.type">
                        </label>
                        <label for="s3Compatible" data-field="spec.type" :class="( (type == 's3Compatible') && 'active' )" tabindex="0">
                            ...
                            Amazon S3<br/>
                            API Compatible
                            <input type="radio" :required='!editMode' v-model="type" value="s3Compatible" id="s3Compatible" data-field="spec.type">
                        </label>
                        <label for="gcs" data-field="spec.type" :class="( (type == 'gcs') && 'active' )" tabindex="0">
                            ...
                            <input type="radio" :required='!editMode' v-model="type" value="gcs" id="gcs" data-field="spec.type">
                        </label>
                        <label for="azureBlob" data-field="spec.type" :class="( (type == 'azureBlob') && 'active' )" tabindex="0">
                            ...
                            Azure Blob Storage
                            <input type="radio" :required='!editMode' v-model="type" value="azureBlob" id="azureBlob" data-field="spec.type">
                        </label>
