				...
				<tbody>
					...
					<template v-for="conf in config" v-if="(conf.data.metadata.namespace == $route.params.namespace)">
						<tr class="base" :class="[ $route.params.name == conf.name ? 'open' : '', 'profile-'+conf.data.metadata.namespace+'-'+conf.name ]" :data-name="conf.name">
							...
							<td class="actions">
								<router-link v-if="iCan('patch','sginstanceprofiles',$route.params.namespace) && !conf.data.status.clusters.length" :to="'/crd/edit/profile/'+$route.params.namespace+'/'+conf.name" title="Edit Configuration">
								...
								<a v-if="iCan('delete','sginstanceprofiles',$route.params.namespace) && !conf.data.status.clusters.length" v-on:click="deleteCRD('sginstanceprofile',$route.params.namespace, conf.name, '/profiles/' + $route.params.namespace)" class="delete" title="Delete Configuration">
