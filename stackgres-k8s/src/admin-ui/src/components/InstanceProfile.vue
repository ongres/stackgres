								...
								<template  v-if="(index >= pagination.start) && (index < pagination.end)">
									<tr class="base">
										<td class="hasTooltip configName">
											<span>
												<router-link :to="'/profiles/' + $route.params.namespace + '/' + conf.name" class="noColor">
													{{ conf.name }}
												</router-link>
											</span>
										</td>
										...
										<td class="actions">
											<router-link :to="'/profiles/' + $route.params.namespace + '/' + conf.name" target="_blank" class="newTab">
