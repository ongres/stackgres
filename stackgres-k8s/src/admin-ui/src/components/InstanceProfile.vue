			...
			<ul class="breadcrumbs">
				...
				<li>
					...
					<template v-if="$route.params.hasOwnProperty('name')">
						<router-link :to="'/' + $route.params.namespace + '/sginstanceprofiles'" title="Namespace Clusters Overview">SGInstanceProfileList</router-link>
					</template>
					<template v-else>
				...
				<div>
					<template v-if="$route.params.hasOwnProperty('name')">
						<template v-for="conf in config" v-if="conf.name == $route.params.name">
							...
							<a v-if="iCan('create','sginstanceprofiles',$route.params.namespace)" @click="cloneCRD('SGInstanceProfile', $route.params.namespace, conf.name)" title="Clone Profile">
								Clone Profile
							</a>
							<a v-if="iCan('delete','sginstanceprofiles',$route.params.namespace)" @click="deleteCRD('sginstanceprofile',$route.params.namespace, conf.name, '/' + $route.params.namespace + '/sginstanceprofiles')" title="Delete Profile" :class="conf.data.status.clusters.length ? 'disabled' : ''">
								Delete Profile
							</a>
