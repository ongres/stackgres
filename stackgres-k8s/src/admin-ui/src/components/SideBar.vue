<template>
	<aside id="side" :class="$route.params.namespace" v-if="loggedIn && isReady">
		...
		<ul id="ns-select" tabindex="0" class="set namespaces">
			<template v-for="namespace in namespaces">
				<li v-bind:class="{'active':(namespace == $route.params.namespace)}">
					<router-link :to="'/overview/'+namespace" class="item namespace" :class="(namespace == $route.params.namespace) ? 'router-link-exact-active' : ''" :title="namespace">{{ namespace }}</router-link>
				</li>
			</template>
		</ul>
		<div id="sets">
			<div v-if="iCan('','sgclusters')" class="set clu" :class="$route.name.includes('Cluster') ? 'active' : ''" >
				<router-link :to="'/overview/'+$route.params.namespace" title="Overview" class="view nav-item">
				...
				<router-link :to="'/crd/create/cluster/'+$route.params.namespace" class="addnew" v-if="iCan('create', 'sgclusters', $route.params.namespace)">
				...
				<ul v-if="iCan('list', 'sgclusters', $route.params.namespace)">
					<template v-for="cluster in clusters">
						<li v-if="cluster.data.metadata.namespace == $route.params.namespace" :class="'sgcluster-'+cluster.data.metadata.namespace+'-'+cluster.name">
							<router-link :to="'/cluster/status/'+cluster.data.metadata.namespace+'/'+cluster.name" class="item cluster" :title="cluster.name" :class="( ($route.params.hasOwnProperty('cluster') || currentComponent == 'CreateCluster') && $route.params.name == cluster.name) ? 'router-link-exact-active' : ''">{{ cluster.name }}</router-link>
						</li>
					</template>
				</ul>

			</div>
			<div v-if="iCan('','sginstanceprofiles')" class="prof set" :class="$route.name.includes('Profile') ? 'active' : ''">
				<router-link :to="'/profiles/'+$route.params.namespace" class="nav-item">
				...
				<router-link :to="'/crd/create/profile/'+$route.params.namespace" class="addnew" v-if="iCan('create', 'sginstanceprofiles', $route.params.namespace)">
					<svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" viewBox="0 0 19 19"><g transform="translate(-573 -706)"><g transform="translate(573 706)" fill="none" stroke="#00adb5" stroke-width="2"><circle cx="9.5" cy="9.5" r="9.5" stroke="none"/><circle cx="9.5" cy="9.5" r="8.5" fill="none"/></g><g transform="translate(-30.5 28.8)"><g transform="translate(609 686)" fill="#00adb5" stroke="#00adb5" stroke-width="1"><rect width="8" height="1.4" rx="0.7" stroke="none"/><rect x="0.5" y="0.5" width="7" height="0.4" rx="0.2" fill="none"/></g><g transform="translate(613.7 682.7) rotate(90)" fill="#00adb5" stroke="#00adb5" stroke-width="1"><rect width="8" height="1.4" rx="0.7" stroke="none"/><rect x="0.5" y="0.5" width="7" height="0.4" rx="0.2" fill="none"/></g></g></g></svg>
				</router-link>
				<ul v-if="iCan('list', 'sginstanceprofiles', $route.params.namespace)">
					<template v-for="profile in profiles">
						<li v-if="profile.data.metadata.namespace == $route.params.namespace" :class="'profile-'+profile.data.metadata.namespace+'-'+profile.name">
			...
			<div class="set conf active">
				...
				<ul>
					<div v-if="iCan('','sgpgconfigs')" class="pg set" :class="$route.name.includes('PgConfig') ? 'active' : ''" >
						<router-link :to="'/configurations/postgres/'+$route.params.namespace" class="nav-item">
						...
						<router-link :to="'/crd/create/pgconfig/'+$route.params.namespace" class="addnew" v-if="iCan('create', 'sgpgconfigs', $route.params.namespace)">
							<svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" viewBox="0 0 19 19"><g transform="translate(-573 -706)"><g transform="translate(573 706)" fill="none" stroke="#00adb5" stroke-width="2"><circle cx="9.5" cy="9.5" r="9.5" stroke="none"/><circle cx="9.5" cy="9.5" r="8.5" fill="none"/></g><g transform="translate(-30.5 28.8)"><g transform="translate(609 686)" fill="#00adb5" stroke="#00adb5" stroke-width="1"><rect width="8" height="1.4" rx="0.7" stroke="none"/><rect x="0.5" y="0.5" width="7" height="0.4" rx="0.2" fill="none"/></g><g transform="translate(613.7 682.7) rotate(90)" fill="#00adb5" stroke="#00adb5" stroke-width="1"><rect width="8" height="1.4" rx="0.7" stroke="none"/><rect x="0.5" y="0.5" width="7" height="0.4" rx="0.2" fill="none"/></g></g></g></svg>
						</router-link>
						<ul v-if="iCan('list', 'sgpgconfigs', $route.params.namespace)">
							<template v-for="config in pgConfig">
								<li v-if="config.data.metadata.namespace == $route.params.namespace" :class="'sgpgconfig-'+config.data.metadata.namespace+'-'+config.name">
					...
					<div v-if="iCan('','sgpoolconfigs')" class="pool set" :class="$route.name.includes('PoolConfig') ? 'active' : ''" >
						<router-link :to="'/configurations/connectionpooling/'+$route.params.namespace" class="nav-item">
						...
						<ul v-if="iCan('list', 'sgpoolconfigs', $route.params.namespace)">
							<template v-for="config in poolConfig">
								<li v-if="config.data.metadata.namespace == $route.params.namespace" :class="'sgpoolconfig-'+config.data.metadata.namespace+'-'+config.name">
						...
						<router-link :to="'/crd/create/connectionpooling/'+$route.params.namespace" class="addnew" v-if="iCan('create', 'sgpoolconfigs', $route.params.namespace)">
							<svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" viewBox="0 0 19 19"><g transform="translate(-573 -706)"><g transform="translate(573 706)" fill="none" stroke="#00adb5" stroke-width="2"><circle cx="9.5" cy="9.5" r="9.5" stroke="none"/><circle cx="9.5" cy="9.5" r="8.5" fill="none"/></g><g transform="translate(-30.5 28.8)"><g transform="translate(609 686)" fill="#00adb5" stroke="#00adb5" stroke-width="1"><rect width="8" height="1.4" rx="0.7" stroke="none"/><rect x="0.5" y="0.5" width="7" height="0.4" rx="0.2" fill="none"/></g><g transform="translate(613.7 682.7) rotate(90)" fill="#00adb5" stroke="#00adb5" stroke-width="1"><rect width="8" height="1.4" rx="0.7" stroke="none"/><rect x="0.5" y="0.5" width="7" height="0.4" rx="0.2" fill="none"/></g></g></g></svg>
						</router-link>
					</div>

					<div v-if="iCan('','sgbackupconfigs')" class="backup set" :class="$route.name.includes('BackupConfig') ? 'active' : ''" >
						<router-link :to="'/configurations/backup/'+$route.params.namespace" class="nav-item">
						...
						<router-link :to="'/crd/create/backupconfig/'+$route.params.namespace" class="addnew" v-if="iCan('create', 'sgbackupconfigs', $route.params.namespace)">
							<svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" viewBox="0 0 19 19"><g transform="translate(-573 -706)"><g transform="translate(573 706)" fill="none" stroke="#00adb5" stroke-width="2"><circle cx="9.5" cy="9.5" r="9.5" stroke="none"/><circle cx="9.5" cy="9.5" r="8.5" fill="none"/></g><g transform="translate(-30.5 28.8)"><g transform="translate(609 686)" fill="#00adb5" stroke="#00adb5" stroke-width="1"><rect width="8" height="1.4" rx="0.7" stroke="none"/><rect x="0.5" y="0.5" width="7" height="0.4" rx="0.2" fill="none"/></g><g transform="translate(613.7 682.7) rotate(90)" fill="#00adb5" stroke="#00adb5" stroke-width="1"><rect width="8" height="1.4" rx="0.7" stroke="none"/><rect x="0.5" y="0.5" width="7" height="0.4" rx="0.2" fill="none"/></g></g></g></svg>
						</router-link>
						<ul v-if="iCan('list', 'sgbackupconfigs', $route.params.namespace)">
							<template v-for="config in bkConfig">
								<li v-if="config.data.metadata.namespace == $route.params.namespace" :class="'sgbackupconfig-'+config.data.metadata.namespace+'-'+config.name">
			...
			<div v-if="iCan('', 'sgdistributedlogs')" class="set logs" :class="$route.name.includes('LogsServer') ? 'active' : ''" >
				<router-link :to="'/logs/'+$route.params.namespace" title="Logs Servers" class="nav-item">
				...
				<router-link :to="'/crd/create/logs/'+$route.params.namespace" class="addnew" v-if="iCan('create', 'sgdistributedlogs', $route.params.namespace)">
					<svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" viewBox="0 0 19 19"><g transform="translate(-573 -706)"><g transform="translate(573 706)" fill="none" stroke="#00adb5" stroke-width="2"><circle cx="9.5" cy="9.5" r="9.5" stroke="none"/><circle cx="9.5" cy="9.5" r="8.5" fill="none"/></g><g transform="translate(-30.5 28.8)"><g transform="translate(609 686)" fill="#00adb5" stroke="#00adb5" stroke-width="1"><rect width="8" height="1.4" rx="0.7" stroke="none"/><rect x="0.5" y="0.5" width="7" height="0.4" rx="0.2" fill="none"/></g><g transform="translate(613.7 682.7) rotate(90)" fill="#00adb5" stroke="#00adb5" stroke-width="1"><rect width="8" height="1.4" rx="0.7" stroke="none"/><rect x="0.5" y="0.5" width="7" height="0.4" rx="0.2" fill="none"/></g></g></g></svg>
				</router-link>
				<ul v-if="iCan('list', 'sgdistributedlogs', $route.params.namespace)">
					<template v-for="log in logsClusters">
						<li v-if="log.data.metadata.namespace == $route.params.namespace" :class="'sgdistributed-log-'+log.data.metadata.namespace+'-'+log.name">
							<router-link :to="'/logs/'+log.data.metadata.namespace+'/'+log.name" class="item" :title="log.name">{{ log.name }}</router-link>
						</li>
					</template>
				</ul>
			</div>
			<div v-if="iCan('','sgbackups')" class="set backups" :class="$route.name.includes('Backups') ? 'active' : ''" >
				<router-link :to="'/backups/'+$route.params.namespace" title="Backups" class="nav-item">
				...
				<router-link :to="'/crd/create/backup/'+$route.params.namespace" class="addnew" v-if="iCan('create', 'sgbackups', $route.params.namespace)">
					<svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" viewBox="0 0 19 19"><g transform="translate(-573 -706)"><g transform="translate(573 706)" fill="none" stroke="#00adb5" stroke-width="2"><circle cx="9.5" cy="9.5" r="9.5" stroke="none"/><circle cx="9.5" cy="9.5" r="8.5" fill="none"/></g><g transform="translate(-30.5 28.8)"><g transform="translate(609 686)" fill="#00adb5" stroke="#00adb5" stroke-width="1"><rect width="8" height="1.4" rx="0.7" stroke="none"/><rect x="0.5" y="0.5" width="7" height="0.4" rx="0.2" fill="none"/></g><g transform="translate(613.7 682.7) rotate(90)" fill="#00adb5" stroke="#00adb5" stroke-width="1"><rect width="8" height="1.4" rx="0.7" stroke="none"/><rect x="0.5" y="0.5" width="7" height="0.4" rx="0.2" fill="none"/></g></g></g></svg>
				</router-link>
			</div>
		</div>
...
<script>
    ...
    export default {
		...
		computed: {
			...
			hasClusters () {
				const vc = this
				let index = store.state.clusters.find(c => (vc.$route.params.namespace == c.data.metadata.namespace) );
			...
			hasPGConfig () {
				let index = store.state.pgConfig.find(c => (vc.$route.params.namespace == c.data.metadata.namespace) );
			...
			hasPoolConfig () {
				let index = store.state.poolConfig.find(c => (vc.$route.params.namespace == c.data.metadata.namespace) );
			...
			hasBackupConfig () {
				let index = store.state.backupConfig.find(c => (vc.$route.params.namespace == c.data.metadata.namespace) );
			...
			hasProfiles () {
				let index = store.state.profiles.find(c => (vc.$route.params.namespace == c.data.metadata.namespace) );
