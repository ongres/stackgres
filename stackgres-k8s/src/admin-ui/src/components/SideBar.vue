	...
	<aside id="side" :class="currentPath.namespace" v-if="loggedIn && isReady">
		...
		<ul id="ns-select" tabindex="0" class="set namespaces">
			<template v-for="namespace in namespaces">
				<li v-bind:class="{'active':(namespace == currentPath.namespace)}">
					<router-link :to="'/overview/'+namespace" class="item namespace" :class="(namespace == currentPath.namespace) ? 'router-link-exact-active' : ''" :title="namespace">{{ namespace }}</router-link>
				</li>
			</template>
		</ul>
		<div id="sets" v-if="!notFound && currentPath.namespace.length">
			<div v-if="iCan('','sgclusters')" class="set clu" :class="currentPath.component.includes('Cluster') ? 'active' : ''" >
				<router-link :to="'/overview/'+currentPath.namespace" title="Overview" class="view nav-item">
				...
				<router-link :to="'/crd/create/cluster/'+currentPath.namespace" class="addnew" v-if="iCan('create', 'sgclusters', currentPath.namespace)">
			...
			<div v-if="iCan('','sginstanceprofiles')" class="prof set" :class="currentPath.component.includes('Profile') ? 'active' : ''">
				<router-link :to="'/profiles/'+currentPath.namespace" class="nav-item">
				...
				<router-link :to="'/crd/create/profile/'+currentPath.namespace" class="addnew" v-if="iCan('create', 'sginstanceprofiles', currentPath.namespace)">
					<svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" viewBox="0 0 19 19"><g transform="translate(-573 -706)"><g transform="translate(573 706)" fill="none" stroke="#00adb5" stroke-width="2"><circle cx="9.5" cy="9.5" r="9.5" stroke="none"/><circle cx="9.5" cy="9.5" r="8.5" fill="none"/></g><g transform="translate(-30.5 28.8)"><g transform="translate(609 686)" fill="#00adb5" stroke="#00adb5" stroke-width="1"><rect width="8" height="1.4" rx="0.7" stroke="none"/><rect x="0.5" y="0.5" width="7" height="0.4" rx="0.2" fill="none"/></g><g transform="translate(613.7 682.7) rotate(90)" fill="#00adb5" stroke="#00adb5" stroke-width="1"><rect width="8" height="1.4" rx="0.7" stroke="none"/><rect x="0.5" y="0.5" width="7" height="0.4" rx="0.2" fill="none"/></g></g></g></svg>
				</router-link>
			...
			<div class="set conf active">
				...
				<ul>
					<div v-if="iCan('','sgpgconfigs')" class="pg set" :class="currentPath.component.includes('PgConfig') ? 'active' : ''" >
						<router-link :to="'/configurations/postgres/'+currentPath.namespace" class="nav-item">
						...
						<router-link :to="'/crd/create/pgconfig/'+currentPath.namespace" class="addnew" v-if="iCan('create', 'sgpgconfigs', currentPath.namespace)">
							<svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" viewBox="0 0 19 19"><g transform="translate(-573 -706)"><g transform="translate(573 706)" fill="none" stroke="#00adb5" stroke-width="2"><circle cx="9.5" cy="9.5" r="9.5" stroke="none"/><circle cx="9.5" cy="9.5" r="8.5" fill="none"/></g><g transform="translate(-30.5 28.8)"><g transform="translate(609 686)" fill="#00adb5" stroke="#00adb5" stroke-width="1"><rect width="8" height="1.4" rx="0.7" stroke="none"/><rect x="0.5" y="0.5" width="7" height="0.4" rx="0.2" fill="none"/></g><g transform="translate(613.7 682.7) rotate(90)" fill="#00adb5" stroke="#00adb5" stroke-width="1"><rect width="8" height="1.4" rx="0.7" stroke="none"/><rect x="0.5" y="0.5" width="7" height="0.4" rx="0.2" fill="none"/></g></g></g></svg>
						</router-link>
					...
					<div v-if="iCan('','sgpoolconfigs')" class="pool set" :class="currentPath.component.includes('PoolConfig') ? 'active' : ''" >
						<router-link :to="'/configurations/connectionpooling/'+currentPath.namespace" class="nav-item">
						...
						<router-link :to="'/crd/create/connectionpooling/'+currentPath.namespace" class="addnew" v-if="iCan('create', 'sgpoolconfigs', currentPath.namespace)">
							<svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" viewBox="0 0 19 19"><g transform="translate(-573 -706)"><g transform="translate(573 706)" fill="none" stroke="#00adb5" stroke-width="2"><circle cx="9.5" cy="9.5" r="9.5" stroke="none"/><circle cx="9.5" cy="9.5" r="8.5" fill="none"/></g><g transform="translate(-30.5 28.8)"><g transform="translate(609 686)" fill="#00adb5" stroke="#00adb5" stroke-width="1"><rect width="8" height="1.4" rx="0.7" stroke="none"/><rect x="0.5" y="0.5" width="7" height="0.4" rx="0.2" fill="none"/></g><g transform="translate(613.7 682.7) rotate(90)" fill="#00adb5" stroke="#00adb5" stroke-width="1"><rect width="8" height="1.4" rx="0.7" stroke="none"/><rect x="0.5" y="0.5" width="7" height="0.4" rx="0.2" fill="none"/></g></g></g></svg>
						</router-link>
					</div>

					<div v-if="iCan('','sgbackupconfigs')" class="backup set" :class="currentPath.component.includes('BackupConfig') ? 'active' : ''" >
						<router-link :to="'/configurations/backup/'+currentPath.namespace" class="nav-item">
						...
						<router-link :to="'/crd/create/backupconfig/'+currentPath.namespace" class="addnew" v-if="iCan('create', 'sgbackupconfigs', currentPath.namespace)">
							<svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" viewBox="0 0 19 19"><g transform="translate(-573 -706)"><g transform="translate(573 706)" fill="none" stroke="#00adb5" stroke-width="2"><circle cx="9.5" cy="9.5" r="9.5" stroke="none"/><circle cx="9.5" cy="9.5" r="8.5" fill="none"/></g><g transform="translate(-30.5 28.8)"><g transform="translate(609 686)" fill="#00adb5" stroke="#00adb5" stroke-width="1"><rect width="8" height="1.4" rx="0.7" stroke="none"/><rect x="0.5" y="0.5" width="7" height="0.4" rx="0.2" fill="none"/></g><g transform="translate(613.7 682.7) rotate(90)" fill="#00adb5" stroke="#00adb5" stroke-width="1"><rect width="8" height="1.4" rx="0.7" stroke="none"/><rect x="0.5" y="0.5" width="7" height="0.4" rx="0.2" fill="none"/></g></g></g></svg>
						</router-link>
			...
			<div v-if="iCan('', 'sgdistributedlogs')" class="set logs" :class="currentPath.component.includes('LogsServer') ? 'active' : ''" >
				<router-link :to="'/logs/'+currentPath.namespace" title="Logs Servers" class="nav-item">
				...
				<router-link :to="'/crd/create/logs/'+currentPath.namespace" class="addnew" v-if="iCan('create', 'sgdistributedlogs', currentPath.namespace)">
					<svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" viewBox="0 0 19 19"><g transform="translate(-573 -706)"><g transform="translate(573 706)" fill="none" stroke="#00adb5" stroke-width="2"><circle cx="9.5" cy="9.5" r="9.5" stroke="none"/><circle cx="9.5" cy="9.5" r="8.5" fill="none"/></g><g transform="translate(-30.5 28.8)"><g transform="translate(609 686)" fill="#00adb5" stroke="#00adb5" stroke-width="1"><rect width="8" height="1.4" rx="0.7" stroke="none"/><rect x="0.5" y="0.5" width="7" height="0.4" rx="0.2" fill="none"/></g><g transform="translate(613.7 682.7) rotate(90)" fill="#00adb5" stroke="#00adb5" stroke-width="1"><rect width="8" height="1.4" rx="0.7" stroke="none"/><rect x="0.5" y="0.5" width="7" height="0.4" rx="0.2" fill="none"/></g></g></g></svg>
				</router-link>
				<ul v-if="iCan('list', 'sgdistributedlogs', currentPath.namespace)">
			...
			<div v-if="iCan('','sgbackups')" class="set backups" :class="( currentPath.component.includes('Backups') && !currentPath.component.includes('Cluster') ) ? 'active' : ''" >
				...
				<router-link :to="'/crd/create/backup/'+currentPath.namespace" class="addnew" v-if="iCan('create', 'sgbackups', currentPath.namespace)">
					<svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" viewBox="0 0 19 19"><g transform="translate(-573 -706)"><g transform="translate(573 706)" fill="none" stroke="#00adb5" stroke-width="2"><circle cx="9.5" cy="9.5" r="9.5" stroke="none"/><circle cx="9.5" cy="9.5" r="8.5" fill="none"/></g><g transform="translate(-30.5 28.8)"><g transform="translate(609 686)" fill="#00adb5" stroke="#00adb5" stroke-width="1"><rect width="8" height="1.4" rx="0.7" stroke="none"/><rect x="0.5" y="0.5" width="7" height="0.4" rx="0.2" fill="none"/></g><g transform="translate(613.7 682.7) rotate(90)" fill="#00adb5" stroke="#00adb5" stroke-width="1"><rect width="8" height="1.4" rx="0.7" stroke="none"/><rect x="0.5" y="0.5" width="7" height="0.4" rx="0.2" fill="none"/></g></g></g></svg>
				</router-link>
			</div>
			<div class="set dbops" :class="currentPath.component.includes('DbOps') ? 'active' : ''" >
				<router-link :to="'/dbops/'+currentPath.namespace" title="Database Operations" class="nav-item">
				...
				<router-link :to="'/crd/create/dbops/'+currentPath.namespace" class="addnew">
					<svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" viewBox="0 0 19 19"><g transform="translate(-573 -706)"><g transform="translate(573 706)" fill="none" stroke="#00adb5" stroke-width="2"><circle cx="9.5" cy="9.5" r="9.5" stroke="none"/><circle cx="9.5" cy="9.5" r="8.5" fill="none"/></g><g transform="translate(-30.5 28.8)"><g transform="translate(609 686)" fill="#00adb5" stroke="#00adb5" stroke-width="1"><rect width="8" height="1.4" rx="0.7" stroke="none"/><rect x="0.5" y="0.5" width="7" height="0.4" rx="0.2" fill="none"/></g><g transform="translate(613.7 682.7) rotate(90)" fill="#00adb5" stroke="#00adb5" stroke-width="1"><rect width="8" height="1.4" rx="0.7" stroke="none"/><rect x="0.5" y="0.5" width="7" height="0.4" rx="0.2" fill="none"/></g></g></g></svg>
				</router-link>
			</div>
