<template>
	<aside id="nav" class="disabled">
		<div id="logo">
			<router-link :to="'/overview/'+currentNamespace" title="Overview">
		...
		<div class="right">
			...
			<div id="tzToggle" class="cursor" :class="timezone" @click="toggleTimezone()" :title="'Switch timezone to ' + ((timezone == 'local') ? 'UTC' : 'Local')">
