...
class JsonType extends AbstractType {
  ...
  private boolean isJsonb(Schema schema) {
    // Unless column type propagation is enabled; Debezium emits JSON and JSONB data
    // as the Json
    // logical type and there is no differentiation that can be made to determine if
    // the source
    // was JSONB; therefore column type propagation must be enabled for this to be
    // possible.
