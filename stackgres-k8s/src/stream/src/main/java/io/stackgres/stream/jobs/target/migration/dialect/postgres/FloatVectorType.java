...
/**
 * An implementation of {@link AbstractFloatVectorType} for PGVector's
 * {@code halfvec} data type.
 *
 * A {@code halfvec} data type is a vector data type that supports storing
 * half-precision vectors.
 *
 * The PostgreSQL connector serializes {@code halfvec} data types using the
 * Debezium semantic type {@link io.debezium.data.vector.FloatVector}, which
 * represents an array of {@code FLOAT32} values.
 *
