...
/**
 * An implementation of {@link AbstractDoubleVectorType} for PGVector's
 * {@code vector} data type.
 *
 * A {@code vector} data type is a vector data type that supports storing
 * full-precision vectors.
 *
 * The PostgreSQL connector serializes {@code vector} data types using the
 * Debezium semantic type {@link io.debezium.data.vector.DoubleVector|, which
 * represents an arary of {@code FLOAT64} values.
 *
