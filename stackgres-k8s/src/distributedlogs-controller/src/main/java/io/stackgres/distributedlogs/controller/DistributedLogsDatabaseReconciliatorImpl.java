...
@ApplicationScoped
public class DistributedLogsDatabaseReconciliatorImpl
    implements DistributedLogsDatabaseReconciliator {
  ...
  @Inject
  public DistributedLogsDatabaseReconciliatorImpl(Parameters parameters) {
    ...
    existsDatabaseTemplate = JdbcStatementTemplate.fromResource(
        DistributedLogsDatabaseReconciliatorImpl.class.getResource("/exists-database.sql"));
    createDatabaseTemplate = JdbcStatementTemplate.fromResource(
        DistributedLogsDatabaseReconciliatorImpl.class.getResource("/create-database.sql"));
    updateRetentionTemplate = JdbcStatementTemplate.fromResource(
        DistributedLogsDatabaseReconciliatorImpl.class.getResource("/update-retention.sql"));
    reconcileRetentionTemplate = JdbcStatementTemplate.fromResource(
        DistributedLogsDatabaseReconciliatorImpl.class.getResource("/reconcile-retention.sql"));
  }
