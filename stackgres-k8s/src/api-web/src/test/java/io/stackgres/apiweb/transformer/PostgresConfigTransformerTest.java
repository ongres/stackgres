...
class PostgresConfigTransformerTest {
  ...
  void realConfigDto_shouldBeTransformerd() throws Exception {
    ...
    Assertions.assertEquals(24,
        transformed.getSpec().getPostgresqlConf().size());
    Assertions.assertEquals("/var/lib/postgresql/10/main", transformed.getSpec().getPostgresqlConf().get("data_directory"));
    Assertions.assertEquals("/etc/postgresql/10/main/pg_hba.conf", transformed.getSpec().getPostgresqlConf().get("hba_file"));
    Assertions.assertEquals("/etc/postgresql/10/main/pg_ident.conf", transformed.getSpec().getPostgresqlConf().get("ident_file"));
    Assertions.assertEquals("/var/run/postgresql/10-main.pid", transformed.getSpec().getPostgresqlConf().get("external_pid_file"));
    Assertions.assertEquals("5432", transformed.getSpec().getPostgresqlConf().get("port"));
    Assertions.assertEquals("100", transformed.getSpec().getPostgresqlConf().get("max_connections"));
    Assertions.assertEquals("/var/run/postgresql", transformed.getSpec().getPostgresqlConf().get("unix_socket_directories"));
    Assertions.assertEquals("on", transformed.getSpec().getPostgresqlConf().get("ssl"));
    Assertions.assertEquals("/etc/ssl/certs/ssl-cert-snakeoil.pem", transformed.getSpec().getPostgresqlConf().get("ssl_cert_file"));
    Assertions.assertEquals("/etc/ssl/private/ssl-cert-snakeoil.key", transformed.getSpec().getPostgresqlConf().get("ssl_key_file"));
    Assertions.assertEquals("128MB", transformed.getSpec().getPostgresqlConf().get("shared_buffers"));
    Assertions.assertEquals("posix", transformed.getSpec().getPostgresqlConf().get("dynamic_shared_memory_type"));
    Assertions.assertEquals("%m [%p] %q%u@%d ", transformed.getSpec().getPostgresqlConf().get("log_line_prefix"));
    Assertions.assertEquals("Europe/Madrid", transformed.getSpec().getPostgresqlConf().get("log_timezone"));
    Assertions.assertEquals("10/main", transformed.getSpec().getPostgresqlConf().get("cluster_name"));
    Assertions.assertEquals("/var/run/postgresql/10-main.pg_stat_tmp", transformed.getSpec().getPostgresqlConf().get("stats_temp_directory"));
    Assertions.assertEquals("iso, dmy", transformed.getSpec().getPostgresqlConf().get("datestyle"));
    Assertions.assertEquals("Europe/Madrid", transformed.getSpec().getPostgresqlConf().get("timezone"));
    Assertions.assertEquals("en_US.UTF-8", transformed.getSpec().getPostgresqlConf().get("lc_messages"));
    Assertions.assertEquals("es_ES.UTF-8", transformed.getSpec().getPostgresqlConf().get("lc_monetary"));
    Assertions.assertEquals("es_ES.UTF-8", transformed.getSpec().getPostgresqlConf().get("lc_numeric"));
    Assertions.assertEquals("es_ES.UTF-8", transformed.getSpec().getPostgresqlConf().get("lc_time"));
    Assertions.assertEquals("pg_catalog.english", transformed.getSpec().getPostgresqlConf().get("default_text_search_config"));
