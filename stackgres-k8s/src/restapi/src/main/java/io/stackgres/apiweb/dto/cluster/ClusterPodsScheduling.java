...
public class ClusterPodsScheduling extends AdditionalProperties {
  ...
  private ClusterPodsSchedulingBackup backup;
  ...
  public ClusterPodsSchedulingBackup getBackup() {
    return backup;
  }

  public void setBackup(ClusterPodsSchedulingBackup backup) {
    this.backup = backup;
  }
