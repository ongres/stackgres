...
class ClusterPostgresSslContextAppenderTest {

  private ClusterPostgresSslContextAppender contextAppender;
  ...
  void setUp() {
    ...
    contextAppender = new ClusterPostgresSslContextAppender(secretFinder);
  }
