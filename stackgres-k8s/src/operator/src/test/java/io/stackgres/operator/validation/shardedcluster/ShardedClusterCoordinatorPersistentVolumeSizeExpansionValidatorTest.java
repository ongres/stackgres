...
class ShardedClusterCoordinatorPersistentVolumeSizeExpansionValidatorTest extends
  ...
  protected PersistentVolumeSizeExpansionValidator<StackGresShardedClusterReview,
    ...
    return new ShardedClusterCoordinatorPersistentVolumeSizeExpansionValidator(
