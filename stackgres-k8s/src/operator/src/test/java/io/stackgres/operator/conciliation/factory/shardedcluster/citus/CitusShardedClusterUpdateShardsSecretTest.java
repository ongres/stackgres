...
class CitusShardedClusterUpdateShardsSecretTest {
  ...
  private CitusShardedClusterUpdateShardsSecret factory;

  private StackGresShardedCluster cluster;

  @BeforeEach
  void setUp() {
    factory = new CitusShardedClusterUpdateShardsSecret(labelFactory);
