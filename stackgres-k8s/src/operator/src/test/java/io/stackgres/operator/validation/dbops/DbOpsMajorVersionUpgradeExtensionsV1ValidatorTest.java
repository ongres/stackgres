...
class DbOpsMajorVersionUpgradeExtensionsV1ValidatorTest {
  ...
  void setUp() {
    ...
    cluster.getMetadata().setAnnotations(Map.of(StackGresKeys.VERSION_KEY, StackGresVersion.LATEST.getVersion()));
