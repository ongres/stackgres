...
public class FullTextSearchUtilTest {
  ...
  public void singleTermQueryTest() {
    assertEquals("test:*", FullTextSearchUtil.fromGoogleLikeQuery("test"));
  }
  ...
  public void doubleTermQueryTest() {
    assertEquals("test1:* & test2:*", FullTextSearchUtil.fromGoogleLikeQuery("test1 test2"));
  }
  ...
  public void exactAndBetweenTermsQueryTest() {
    assertEquals("test1:* & test2 <-> test3 & test4:*",
        FullTextSearchUtil.fromGoogleLikeQuery("test1 \"test2 test3\" test4"));
  }
