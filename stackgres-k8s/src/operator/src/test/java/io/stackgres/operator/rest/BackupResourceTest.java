...
class BackupResourceTest
  ...
  protected void checkDto(BackupDto resource) {
    ...
    assertEquals(0, resource.getStatus().getBackupConfig().getBaseBackup().getPerformance().getDiskRateLimit());
    assertNull(resource.getStatus().getBackupConfig().getBaseBackup().getFullSchedule());
    assertEquals(0, resource.getStatus().getBackupConfig().getBaseBackup().getPerformance().getNetworkRateLimit());
    assertEquals(0, resource.getStatus().getBackupConfig().getBaseBackup().getRetention());
  ...
  protected void checkCustomResource(StackGresBackup resource, Operation operation) {
    ...
    switch (operation) {
      case UPDATE:
        ...
        assertEquals(0, resource.getStatus().getBackupConfig().getBaseBackups().getPerformance().getMaxDiskBandwitdh());
        assertNull(resource.getStatus().getBackupConfig().getBaseBackups().getCronSchedule());
        assertEquals(0, resource.getStatus().getBackupConfig().getBaseBackups().getPerformance().getMaxNetworkBandwitdh());
