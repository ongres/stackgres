...
class DdpShardedClusterCoordinatorScriptTest {
  ...
  private DdpShardedClusterCoordinatorScript factory;

  private StackGresShardedCluster cluster;

  @BeforeEach
  void setUp() {
    factory = new DdpShardedClusterCoordinatorScript(labelFactory);
