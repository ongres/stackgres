...
class ShardedClusterShardsPostgresConfigContextAppenderTest {

  private ShardedClusterShardsPostgresConfigContextAppender contextAppender;
  ...
  void setUp() {
    ...
    contextAppender = new ShardedClusterShardsPostgresConfigContextAppender(
  ...
  void givenClusterWithoutDefaultPostgresConfig_shouldPass() {
    cluster.getSpec().getShards().getConfigurations().setSgPostgresConfig(
