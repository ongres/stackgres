...
class CoordinatorScriptsConfigMutatorTest {

  protected static final ObjectMapper JSON_MAPPER = new ObjectMapper();

  private CoordinatorScriptsConfigMutator mutator;

  @BeforeEach
  void setUp() throws Exception {
    mutator = new CoordinatorScriptsConfigMutator();
  }
  ...
  void createClusterWithouIds_shouldAddThem() {
    ...
    review.getRequest().getObject().getSpec().getCoordinator().getManagedSql().getScripts().stream()
  ...
  void updateClusterAddingAnEntry_shouldSetId() {
    ...
    review.getRequest().getObject().getSpec().getCoordinator().getManagedSql().getScripts()
