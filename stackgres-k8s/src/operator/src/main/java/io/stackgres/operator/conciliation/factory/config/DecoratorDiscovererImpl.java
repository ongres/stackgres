...
public class DecoratorDiscovererImpl
    extends AbstractResourceDiscoverer<Decorator<StackGresConfigContext>>
  ...
  @Override
  public List<Decorator<StackGresConfigContext>> discoverDecorator(StackGresConfigContext context) {
