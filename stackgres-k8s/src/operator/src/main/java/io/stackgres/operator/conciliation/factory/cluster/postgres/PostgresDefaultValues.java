...
public interface PostgresDefaultValues {
  ...
  enum PostgresDefaulValuesProperties {
    PG_14_VALUES_V_1_20("/v1.20/postgresql-default-values-pg14.properties"),
    PG_13_VALUES_V_1_20("/v1.20/postgresql-default-values-pg13.properties"),
    PG_12_VALUES_V_1_20("/v1.20/postgresql-default-values-pg12.properties"),
  ...
  static @NotNull Properties getProperties(
    ...
    if (version.getVersionAsNumber() <= StackGresVersion.V_1_19.getVersionAsNumber()) {
      if (majorVersion <= 12) {
    ...
    if (majorVersion <= 12) {
      return PostgresDefaulValuesProperties.PG_12_VALUES_V_1_20.properties;
    }
    if (majorVersion <= 13) {
      return PostgresDefaulValuesProperties.PG_13_VALUES_V_1_20.properties;
    }
    return PostgresDefaulValuesProperties.PG_14_VALUES_V_1_20.properties;
  }
