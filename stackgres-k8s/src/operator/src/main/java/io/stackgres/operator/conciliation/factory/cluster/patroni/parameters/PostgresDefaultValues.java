...
public interface PostgresDefaultValues {
  ...
  enum PostgresDefaulValuesProperties {
    ...
    PG_14_VALUES_V_1_6("/v1.6/postgresql-default-values-pg14-v1.6.properties"),
    PG_13_VALUES_V_1_6("/v1.6/postgresql-default-values-pg13-v1.6.properties"),
    PG_12_VALUES_V_1_6("/v1.6/postgresql-default-values-pg12-v1.6.properties"),
  ...
  static @NotNull Properties getProperties(
    ...
    if (version.getVersionAsNumber() <= StackGresVersion.V_1_6.getVersionAsNumber()) {
      if (majorVersion <= 12) {
        return PostgresDefaulValuesProperties.PG_12_VALUES_V_1_6.properties;
      }
      if (majorVersion <= 13) {
        return PostgresDefaulValuesProperties.PG_13_VALUES_V_1_6.properties;
      }
      return PostgresDefaulValuesProperties.PG_14_VALUES_V_1_6.properties;
    }
