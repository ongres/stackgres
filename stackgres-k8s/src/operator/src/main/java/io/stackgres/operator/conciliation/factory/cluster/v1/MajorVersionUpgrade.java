...
public class MajorVersionUpgrade implements ContainerFactory<ClusterContainerContext> {
  ...
  public Container getContainer(ClusterContainerContext context) {
    ...
    final String targetPatroniImageName = StackGresUtil.getPatroniImageName(
        clusterContext.getContext(), clusterContext.getCluster(), targetVersion);
        ...
        new ContainerBuilder()
            ...
            .withCommand("/bin/sh", "-ex",
                ClusterPathV1.TEMPLATES_PATH.path()
                    + "/"
                    + ClusterPathV1.LOCAL_BIN_MAJOR_VERSION_UPGRADE_SH_PATH.filename())
            ...
            .addToEnv(
                ...
                new EnvVarBuilder()
                    ...
                    .withValueFrom(new EnvVarSourceBuilder()
                        ...
                        .build())
                    .build(),
                ClusterPathV1.ETC_POSTGRES_PATH.envVar())
            ...
            .addToVolumeMounts(new VolumeMountBuilder()
                ...
                .withMountPath(ClusterPathV1.ETC_POSTGRES_PATH.path())
                .build())
            .addToVolumeMounts(
