...
public class DdpShardedClusterUpdateShardsSecret implements ResourceGenerator<StackGresShardedClusterContext> {

  final LabelFactoryForShardedCluster labelFactory;

  @Inject
  public DdpShardedClusterUpdateShardsSecret(LabelFactoryForShardedCluster labelFactory) {
