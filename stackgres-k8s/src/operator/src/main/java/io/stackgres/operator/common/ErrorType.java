...
public enum ErrorType {
  ...
  INVALID_CR_REFERENCE("invalid-custom-resource-reference",
      "Invalid custom resource reference"),
  DEFAULT_CONFIGURATION("default-configuration",
      "Default configurations cannot be altered"),
  FORBIDDEN_CR_DELETION("forbidden-custom-resource-deletion",
      "Forbidden custom resource deletion"),
  FORBIDDEN_CR_UPDATE("forbidden-custom-resource-update",
