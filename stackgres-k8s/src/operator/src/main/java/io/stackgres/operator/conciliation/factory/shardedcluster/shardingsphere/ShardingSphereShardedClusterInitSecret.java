...
public class ShardingSphereShardedClusterInitSecret
    implements ResourceGenerator<StackGresShardedClusterContext> {

  final LabelFactoryForShardedCluster labelFactory;

  @Inject
  public ShardingSphereShardedClusterInitSecret(LabelFactoryForShardedCluster labelFactory) {
