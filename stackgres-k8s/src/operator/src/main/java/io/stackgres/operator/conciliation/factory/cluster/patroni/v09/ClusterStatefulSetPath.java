...
public enum ClusterStatefulSetPath implements VolumePath {
  ...
  PG_EXTENSIONS_PATH(PG_EXTENSIONS_BASE_PATH,
      io.stackgres.common.ClusterStatefulSetEnvVars.POSTGRES_MAJOR_VERSION.substVar(),
      io.stackgres.common.ClusterStatefulSetEnvVars.BUILD_MAJOR_VERSION.substVar()),
  ...
  PG_BINARIES_PATH("/usr/lib/postgresql",
      io.stackgres.common.ClusterStatefulSetEnvVars.POSTGRES_VERSION.substVar()),
  ...
  PATRONI_ENV_PATH(BASE_ENV_PATH, io.stackgres.common.ClusterStatefulSetEnvVars.PATRONI_ENV.substVar()),
  PATRONI_CONFIG_PATH("/etc/patroni"),
  BACKUP_ENV_PATH(BASE_ENV_PATH, io.stackgres.common.ClusterStatefulSetEnvVars.BACKUP_ENV.substVar()),
  BACKUP_SECRET_PATH(BASE_SECRET_PATH, io.stackgres.common.ClusterStatefulSetEnvVars.BACKUP_ENV.substVar()),
  RESTORE_ENV_PATH(BASE_ENV_PATH, io.stackgres.common.ClusterStatefulSetEnvVars.RESTORE_ENV.substVar()),
