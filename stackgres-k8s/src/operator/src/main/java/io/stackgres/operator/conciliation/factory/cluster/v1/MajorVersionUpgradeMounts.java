    ...
    return ImmutableList.<VolumeMount>builder()
        ...
        .add(
            new VolumeMountBuilder()
                ...
                .withMountPath(ClusterPathV1.PG_BIN_PATH.path(oldClusterContext))
                .withSubPath(ClusterPathV1.PG_RELOCATED_BIN_PATH
                    .subPath(oldClusterContext, ClusterPathV1.PG_BASE_PATH))
                .build(),
            new VolumeMountBuilder()
                .withName(context.getDataVolumeName())
                .withMountPath(ClusterPathV1.PG_EXTRA_LIB_PATH.path(oldClusterContext))
                .withSubPath(ClusterPathV1.PG_EXTENSIONS_LIB64_PATH
                    .subPath(oldClusterContext, ClusterPathV1.PG_BASE_PATH))
                .build(),
            new VolumeMountBuilder()
                .withName(context.getDataVolumeName())
                .withMountPath(ClusterPathV1.PG_LIB_PATH.path(oldClusterContext))
                .withSubPath(ClusterPathV1.PG_RELOCATED_LIB_PATH
                    .subPath(oldClusterContext, ClusterPathV1.PG_BASE_PATH))
                .build(),
            new VolumeMountBuilder()
                .withName(context.getDataVolumeName())
                .withMountPath(ClusterPathV1.PG_SHARE_PATH.path(oldClusterContext))
                .withSubPath(ClusterPathV1.PG_RELOCATED_SHARE_PATH
                    .subPath(oldClusterContext, ClusterPathV1.PG_BASE_PATH))
                .build(),
            new VolumeMountBuilder()
                .withName(context.getDataVolumeName())
                .withMountPath(ClusterPathV1.PG_EXTENSION_PATH.path(oldClusterContext))
                .withSubPath(ClusterPathV1.PG_EXTENSIONS_EXTENSION_PATH
                    .subPath(oldClusterContext, ClusterPathV1.PG_BASE_PATH))
                .build()
        ).build();
  }
  ...
  public List<EnvVar> getDerivedEnvVars(ClusterContainerContext context) {
    ...
    return ImmutableList.<EnvVar>builder()
        ...
        .add(new EnvVarBuilder()
                ...
                .withValue(ClusterPathV1.PG_BIN_PATH.path(clusterContext))
                .build(),
            new EnvVarBuilder()
                .withName("SOURCE_PG_BIN_PATH")
                .withValue(ClusterPathV1.PG_BIN_PATH.path(oldClusterContext))
                .build(),
            new EnvVarBuilder()
                .withName("TARGET_PG_LIB_PATH")
                .withValue(ClusterPathV1.PG_LIB_PATH.path(clusterContext))
                .build(),
            new EnvVarBuilder()
                .withName("TARGET_PG_LIB64_PATH")
                .withValue(ClusterPathV1.PG_RELOCATED_LIB64_PATH.path(clusterContext))
                .build(),
            new EnvVarBuilder()
            ...
            new EnvVarBuilder()
                ...
                .withValue(ClusterPathV1.PG_LIB_PATH.path(oldClusterContext))
                .build(),
            new EnvVarBuilder()
                .withName("SOURCE_PG_LIB64_PATH")
                .withValue(ClusterPathV1.PG_RELOCATED_LIB64_PATH.path(oldClusterContext))
                .build(),
            new EnvVarBuilder()
                .withName("SOURCE_PG_EXTRA_LIB_PATH")
                .withValue(ClusterPathV1.PG_EXTRA_LIB_PATH.path(oldClusterContext))
                .build())
        .build();
  }
  ...
  private ClusterContext getOldClusterContext(ClusterContainerContext context) {
    ...
    final StackGresCluster oldCluster = new StackGresClusterBuilder(cluster)
        .withSpec(new StackGresClusterSpecBuilder(cluster.getSpec())
            ...
            .build())
        .withNewStatus()
        .withPostgresVersion(context.getOldPostgresVersion().orElseThrow())
        .endStatus()
        .build();
