...
public class CommonEnvVarFactory
    implements ResourceFactory<StackGresDistributedLogsContext, List<EnvVar>> {

  @Override
  public List<EnvVar> createResource(StackGresDistributedLogsContext source) {
