        ...
        new ContainerBuilder()
            ...
            .addToEnv(
                ...
                new EnvVarBuilder()
                    ...
                    .build(),
                new EnvVarBuilder()
                    .withName("TARGET_PG_EXTENSIONS_MOUNTED_LIB64_PATH")
                    .withValue(ClusterStatefulSetPath.PG_EXTENSIONS_MOUNTED_LIB64_PATH.path(
                        context))
                    .build(),
                new EnvVarBuilder()
                    .withName("SOURCE_PG_EXTENSIONS_MOUNTED_LIB64_PATH")
                    .withValue(ClusterStatefulSetPath.PG_EXTENSIONS_MOUNTED_LIB64_PATH.path(
