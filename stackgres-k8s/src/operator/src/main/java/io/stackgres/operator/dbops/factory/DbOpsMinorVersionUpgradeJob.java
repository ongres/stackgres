...
@ApplicationScoped
public class DbOpsMinorVersionUpgradeJob extends DbOpsJob {

  @Inject
  public DbOpsMinorVersionUpgradeJob(StackGresPodSecurityContext clusterPodSecurityContext,
    ...
    List<EnvVar> runEnvVars = ImmutableList.<EnvVar>builder()
        .add(
            ...
            .withValue(Optional.ofNullable(minorVersionUpgrade)
                .map(StackGresDbOpsMinorVersionUpgrade::isMethodReducedImpact)
                .map(String::valueOf)
                .orElse("true"))
            .build(),
            new EnvVarBuilder()
