...
public class ShardingSphereShardedClusterCoordinatorScript
    implements ResourceGenerator<StackGresShardedClusterContext> {

  final LabelFactoryForShardedCluster labelFactory;

  @Inject
  public ShardingSphereShardedClusterCoordinatorScript(LabelFactoryForShardedCluster labelFactory) {
