...
import io.stackgres.operator.conciliation.factory.AbstractContainerCustomEnvDecorator;
import io.stackgres.operator.conciliation.factory.Decorator;
import jakarta.inject.Singleton;

@Singleton
@OperatorVersionBinder
public class ClusterStatefulSetContainerCustomEnvDecorator
    extends AbstractContainerCustomEnvDecorator
  ...
  public HasMetadata decorate(StackGresClusterContext context, HasMetadata resource) {
    if (resource instanceof StatefulSet statefulSet) {
      setCustomEnvContainers(context.getCluster(),
