...
public class ShardingSphereShardedClusterShardsScript implements ResourceGenerator<StackGresShardedClusterContext> {

  final LabelFactoryForShardedCluster labelFactory;

  @Inject
  public ShardingSphereShardedClusterShardsScript(LabelFactoryForShardedCluster labelFactory) {
