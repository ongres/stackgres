...
public class BackupAnnotationDecorator extends AnnotationDecorator<StackGresBackupContext> {
  ...
  protected void decorateCronJobV1Beta1(@NotNull StackGresBackupContext context,
      @NotNull HasMetadata resource) {
  ...
  @Override
  protected @NotNull Map<Class<?>, BiConsumer<StackGresBackupContext, HasMetadata>>
      getCustomDecorators() {
    return ImmutableMap.<Class<?>,
            BiConsumer<StackGresBackupContext, HasMetadata>>builder()
