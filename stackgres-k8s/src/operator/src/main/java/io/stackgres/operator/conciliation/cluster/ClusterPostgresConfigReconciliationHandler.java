...
@ReconciliationScope(value = StackGresCluster.class, kind = StackGresPostgresConfig.KIND)
@ApplicationScoped
public class ClusterPostgresConfigReconciliationHandler
    extends FireAndForgetReconciliationHandler<StackGresCluster> {

  private final LabelFactoryForCluster labelFactory;

  public ClusterPostgresConfigReconciliationHandler(
