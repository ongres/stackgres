...
package io.stackgres.operator.conciliation.factory.cluster.backup.v1;
...
public abstract class AbstractBackupConfigMap {
  ...
  protected ImmutableMap<String, String> getBackupEnvVars(
    ...
    backupEnvVars.put("PGDATA", ClusterPathV1.PG_DATA_PATH.path());
    ...
    backupEnvVars.put("PGHOST", ClusterPathV1.PG_RUN_PATH.path());
  ...
  protected String getAwsS3CompatibleCaCertificateFilePath(ClusterContext context) {
    return ClusterPathV1.BACKUP_SECRET_PATH.path(context)
