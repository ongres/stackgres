            ...
            <div class="form">
                ...
                <fieldset class="fieldset" :disabled="(editMode)" required v-if="backupConfigStorageType.length">
                    ...
                    <template v-if="( (backupConfigStorageType === 's3') || (backupConfigStorageType === 's3Compatible') )">
                        ...
                        <input v-model="backupS3AccessKeyId" required :data-field="'spec.storage.'+backupConfigStorageType+'.awsCredentials.accessKeyId'" type="password">
                        ...
                        <input v-model="backupS3SecretAccessKey" required :data-field="'spec.storage.'+backupConfigStorageType+'.awsCredentials.secretAccessKey'" type="password">
                    ...
                    <template v-if="backupConfigStorageType === 'azureBlob'">
                        ...
                        <input v-model="backupAzureAccount" required data-field="spec.storage.azureBlob.azureCredentials.storageAccount" type="password">
                        ...
                        <input v-model="backupAzureAccessKey" required data-field="spec.storage.azureBlob.azureCredentials.accessKey" type="password">
