...
public class StackGresDbOpsSecurityUpgradeStatus implements KubernetesResource {
  ...
  public boolean equals(Object obj) {
    ...
    if (!(obj instanceof StackGresDbOpsSecurityUpgradeStatus)) {
      return false;
    }
    StackGresDbOpsSecurityUpgradeStatus other = (StackGresDbOpsSecurityUpgradeStatus) obj;
