...
public class StackGresConfigRepositoryCachePersistentVolume {
  ...
  public boolean equals(Object obj) {
    ...
    if (!(obj instanceof StackGresConfigRepositoryCachePersistentVolume)) {
      return false;
    }
    StackGresConfigRepositoryCachePersistentVolume other = (StackGresConfigRepositoryCachePersistentVolume) obj;
