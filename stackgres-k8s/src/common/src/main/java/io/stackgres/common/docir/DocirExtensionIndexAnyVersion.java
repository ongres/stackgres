...
public class DocirExtensionIndexAnyVersion {
  ...
  private DocirExtensionIndexAnyVersion(
  ...
  public DocirExtensionIndexAnyVersion(
  ...
  public static DocirExtensionIndexAnyVersion fromClusterExtension(
      StackGresContext context,
      StackGresCluster cluster,
      StackGresClusterExtension extension,
      boolean detectOs) {
    return new DocirExtensionIndexAnyVersion(
        context,
        cluster,
        extension,
  ...
  public boolean equals(Object obj) {
    ...
    if (!(obj instanceof DocirExtensionIndexAnyVersion)) {
      return false;
    }
    DocirExtensionIndexAnyVersion other = (DocirExtensionIndexAnyVersion) obj;
  ...
  private boolean equalsSameFromIndex(
      DocirExtensionIndexAnyVersion self,
      DocirExtensionIndexAnyVersion other) {
  ...
  private boolean equalsWithFromIndex(
      DocirExtensionIndexAnyVersion other,
      DocirExtensionIndexAnyVersion fromIndex) {
  ...
  public String toString() {
    return String.format(
        "%s/%s/%s-%s%s%s",
        arch.orElse("any"), os.orElse("any"), name,
