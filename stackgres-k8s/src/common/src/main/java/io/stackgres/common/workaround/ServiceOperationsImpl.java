...
public class ServiceOperationsImpl
  ...
  private class HasMetadataOperation
    ...
    public DoneableService edit() throws KubernetesClientException {
      return outer.edit();
    }
    ...
    public Service create(Service... resources) throws KubernetesClientException {
      return outer.create(resources);
    }

    public DoneableService createNew() throws KubernetesClientException {
      return outer.createNew();
    }

    public DoneableService createOrReplaceWithNew() throws KubernetesClientException {
    ...
    public ServiceList list() throws KubernetesClientException {
      return outer.list();
    }

    public ServiceList list(Integer limitVal, String continueVal) throws KubernetesClientException {
    ...
    public Service updateStatus(Service item) throws KubernetesClientException {
    ...
    public FilterWatchListDeletable<Service, ServiceList, Boolean, Watch, Watcher<Service>> withPropagationPolicy(
