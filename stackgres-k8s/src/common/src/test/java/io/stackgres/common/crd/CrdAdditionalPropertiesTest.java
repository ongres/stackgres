...
public class CrdAdditionalPropertiesTest {
  ...
  void crdShouldCaptureUnknownProperties(Class<?> resourceClazz) {
    ModelTestUtil.assertJsonAdditionalProperties(resourceClazz);
  }
